        ...
        <tbody>
            @foreach($suppliers as $supplier)
                <tr>
                    ...
                    <td scope="col">
                      <div class="d-flex">
                        <button type="button" class="btn btn-primary mx-2 btn-detail" data-name="{{ $supplier->name }}" data-email="{{ $supplier->email }}" data-description="{{ $supplier->description }}" data-contact="{{ $supplier->contact }}" data-address="{{ $supplier->address }}" data-joined-date="{{ $supplier->created_at->diffForHumans() }}"><i class="bi bi-eye"></i></button>
