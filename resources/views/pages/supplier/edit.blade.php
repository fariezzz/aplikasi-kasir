...
<div class="mx-3 container-fluid">
    ...
    <div class="col-lg-12 container-fluid">
      ...
      <form class="row g-3" method="POST" action="/suppliers/{{ $supplier->id }}">
        @method('put')
        @csrf
        <div class="col-lg-6">
        ...
        <div class="col-lg-6">
          ...
          <input type="tel" class="form-control @error('contact') is-invalid @enderror" id="contact" name="contact" value="{{ old('contact', $supplier->contact) }}" required>
