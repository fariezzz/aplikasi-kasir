...
<div class="mx-3 container-fluid">
    ...
    @if($users->count())
    <table class="table table-bordered text-center mb-5" style="border-color:rgb(194, 194, 194);">
        <thead>
          <tr>
              ...
              <tr>
                  ...
                  <td scope="col" class="d-flex justify-content-center">
                    ...
                    <form action="/users/{{ $user->id }}" method="POST">
                      @csrf
                      <button class="btn btn-danger mx-2" onclick="confirm('Are you sure to delete the user?')">
                        Delete
                      </button>
                    </form>
                    @else
