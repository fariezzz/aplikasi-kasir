...
<div class="mx-3 container-fluid">
    ...
    <div class="col-lg-12 container-fluid">
      ...
      <form class="row g-3 myForm" method="POST" action="/users">
        @csrf
        <input type="hidden" name="request_id" id="request_id" value="{{ request('request_id') }}">
        <div class="col-lg-6">
        ...
        <div class="col-lg-6">
            ...
            <input type="text" class="form-control @error('username') is-invalid @enderror" id="username" name="username" value="{{ old('username', request('username')) }}" required autofocus>
